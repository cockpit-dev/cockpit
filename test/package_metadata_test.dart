...
void main() {
  test('published packages share the Cockpit 3.0 release version', () {
    ...
    expect(runtimeVersion, '3.0.2');
    expect(protocolVersion, '3.0.2');
    expect(devtoolsVersion, '3.0.2');
    expect(runtimePubspec, contains('cockpit_protocol: ^3.0.2'));
    expect(devtoolsPubspec, contains('cockpit_protocol: ^3.0.2'));
  ...
  test('agent integrations use installed executables and bundled skills', () {
    ...
    expect(kiroPlugin, contains('"version": "3.0.2"'));
