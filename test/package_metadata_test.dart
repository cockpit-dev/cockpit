...
void main() {
  test('published packages share one Cockpit release version', () {
    ...
    expect(runtimeVersion, '4.0.3');
    expect(protocolVersion, '4.0.3');
    expect(devtoolsVersion, '4.0.3');
    expect(runtimePubspec, contains('cockpit_protocol: ^4.0.3'));
    expect(devtoolsPubspec, contains('cockpit_protocol: ^4.0.3'));
    expect(
      supervisorRuntime,
  ...
  test('agent integrations use installed executables and bundled skills', () {
    ...
    expect(kiroPlugin, contains('"version": "4.0.3"'));
