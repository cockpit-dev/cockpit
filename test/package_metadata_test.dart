...
void main() {
  test('published packages expose compatible release versions', () {
    ...
    expect(runtimeVersion, '4.0.24');
    expect(protocolVersion, '4.0.24');
    expect(devtoolsVersion, '4.0.24');
    expect(runtimePubspec, contains('cockpit_protocol: ^4.0.24'));
    expect(devtoolsPubspec, contains('cockpit_protocol: ^4.0.24'));
  ...
  test('agent integrations use installed executables and bundled skills', () {
    ...
    expect(kiroPlugin, contains('"version": "4.0.24"'));
