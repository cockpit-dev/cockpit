...
void main() {
  test('published packages expose compatible release versions', () {
    ...
    expect(runtimeVersion, '4.0.29');
    expect(protocolVersion, '4.0.29');
    expect(devtoolsVersion, '4.0.29');
    expect(runtimePubspec, contains('cockpit_protocol: ^4.0.29'));
    expect(devtoolsPubspec, contains('cockpit_protocol: ^4.0.29'));
  ...
  test('agent integrations use installed executables and bundled skills', () {
    ...
    expect(kiroPlugin, contains('"version": "4.0.29"'));
